...
const badgeVariants = cva(
  "group/badge inline-flex h-5 lg:h-[1.389vw] w-fit shrink-0 items-center justify-center gap-1 lg:gap-[0.278vw] overflow-hidden rounded-4xl lg:rounded-[1.597vw] border border-transparent px-2 lg:px-[0.556vw] py-0.5 lg:py-[0.139vw] text-xs lg:text-[0.833vw] font-medium whitespace-nowrap transition-all focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3!",
  {
    variants: {
      variant: {
