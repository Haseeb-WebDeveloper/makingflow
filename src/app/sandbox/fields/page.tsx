...
const SPECS: Spec[] = [
  ...
  },
  {
    ...
    type: "date",
    config: { includeTime: true, disablePast: true },
    note: "includeTime + disablePast. Stores 2026-09-21T14:30 — one string, still sorts chronologically. Past days are struck through in the calendar.",
  },
  {
    id: "date_birth",
    label: "Date of birth",
    ...
    note: "disableFuture. Type it, or jump a century with the year dropdown.",
  },
  {
    id: "date_window",
    label: "Which day of the conference?",
    type: "date",
    config: { minDate: "2026-06-01", maxDate: "2026-06-03" },
    note: "An absolute window — everything outside 1–3 Jun is unpickable and untypeable.",
  },
